...
# Résultat final : Trio1 Offspring
...
En plus du score contenue dans le bedgraphe, il a également été ajouté la densité en LTR.

On observe alors que les duplications se trouve dans une région présentant une densité en LTR légèrement élevée.
